...
public class PostController {
  ...
  private   UserService userService;
    ...
    public ResponseEntity<ApiResponse<PostDto>> savePostHandler(@PathVariable Integer postId) throws Exception {
        UserDetailsDto currentUser = userContext.getCurrentUser();
        User reqUser = userService.findUserByEmail(currentUser.getEmail());
    ...
    public ResponseEntity<ApiResponse<PostDto>> likePostHandler(@PathVariable Integer postId) throws Exception {
        UserDetailsDto currentUser = userContext.getCurrentUser();
        User reqUser = userService.findUserByEmail(currentUser.getEmail());
